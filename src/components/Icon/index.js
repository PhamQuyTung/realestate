...
export const SearchHomeIcon = ({ width = '100px', height = '100px', className, color = '#f1913d' }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const CoinHomeIcon = ({ width = '100px', height = '100px', className, color = '#f1913d' }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const UpHomeIcon = ({ width = '100px', height = '100px', className, color = '#f1913d' }) => (
    <svg
        className={className}
        width={width}
        height={height}
