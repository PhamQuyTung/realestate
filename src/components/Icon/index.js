// export const BuildingIcon = ({ width = '8rem', height = '8rem', className }) => (
//     <svg
//         className={className}
//         width={width}
//         height={height}
...
export const DashboardsIcon = ({ width = '2rem', height = '2rem', className, color = 'white' }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const ProfileIcon = ({ width = '2rem', height = '2rem', className, color = 'white' }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const PackageIcon = ({ width = '2rem', height = '2rem', className, color = 'white' }) => (
    <svg
        className={className}
        width={width}
        height={height}
    ...
    >
        ...
        <path
            ...
            stroke-linejoin="round"
        ></path>
        <path d="M10 2.5V7.5" stroke="#A8ABAE" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"></path>
    </svg>
);

export const FavoriteIcon = ({ width = '2rem', height = '2rem', className, color = 'white' }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const FileSaveIcon = ({ width = '2rem', height = '2rem', className, color = 'white' }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const ReviewIcon = ({ width = '2rem', height = '2rem', className, color = 'white' }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const PropertiesIcon = ({ width = '2rem', height = '2rem', className, color = 'white' }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const PropertyIcon = ({ width = '2rem', height = '2rem', className, color = 'white' }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const LogoutIcon = ({ width = '2rem', height = '2rem', className, color = 'white' }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
// export const HeartIcon = ({ width = '2rem', height = '2rem', className, color = '#f1913d' }) => (
//     <svg
//         className={className}
//         width={width}
//         height={height}
...
// export const ZoomInIcon = ({ width = '2rem', height = '2rem', className, color = '#f1913d' }) => (
//     <svg
//         className={className}
//         width={width}
//         height={height}
